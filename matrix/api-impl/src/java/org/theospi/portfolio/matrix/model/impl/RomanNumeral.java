 ...
 *
 * $Header: /opt/CVS/osp2.x/matrix/api-impl/src/java/org/theospi/portfolio/matrix/model/impl/RomanNumeral.java,v 1.1 2005/07/15 17:42:04 rpembry Exp $
 * $Revision$
 * $Date$
 */
/*
 ...
 * @author rpembry
 */
public class RomanNumeral implements IdGenerator {
   ...
   public RomanNumeral(boolean useUpperCase) {
   ...
   public boolean hasNext() {
      return true;
      //TODO this Class needs to be fully implemented, or out of bounds exceptions will occur
   }
    ...
    */
   public Object next() {
      if (this.isUseUpperCase()) return numerals[i++]; else return numerals[i++].toLowerCase();
   }
