 ...
 *
 * $Header: /opt/CVS/osp2.x/matrix/api/src/java/org/theospi/portfolio/matrix/model/Attachment.java,v 1.1 2005/07/14 20:41:24 rpembry Exp $
 * $Revision: 3474 $
...
public class CellForm {
   ...
   public boolean equals(Object other) {
      ...
      if (other == null || !(other instanceof CellForm)) return false;
      //TODO need better equals method
      return (this.getId().equals(((CellForm) other).getId()));
