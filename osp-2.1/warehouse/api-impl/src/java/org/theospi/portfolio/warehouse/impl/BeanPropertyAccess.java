...
public class BeanPropertyAccess implements PropertyAccess {
   ...
   private Method propertyGettor = null;
   ...
   public Method getPropertyGettor() {
      return propertyGettor;
   }

   public void setPropertyGettor(Method propertyGettor) {
      this.propertyGettor = propertyGettor;
   }
}
