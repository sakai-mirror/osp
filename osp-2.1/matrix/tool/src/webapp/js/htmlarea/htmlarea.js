...
HTMLArea.prototype.insertHTML = function(html) {
	...
	var range = this._createRange(sel);
	if (HTMLArea.is_ie) {
      var docRange = this._doc.body.createTextRange();
      if (docRange.inRange(range)) {
         range.pasteHTML(html);
      }
      else {
         range = docRange.duplicate();
...
HTMLArea.prototype._comboSelected = function(el, txt) {
	...
	switch (txt) {
	    ...
	    case "artifactfield":
	    case "filedropdown":
   		var combobox = this.config.customSelects[txt];
			combobox.action(this, value);
		break;
