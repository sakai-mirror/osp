...
function osp_dateselectionwidgetpopup(yearselect_id, monthselect_id, dayselect_id)
{
	...
	document.write('<img src="/library/calendar/images/calendar/cal.gif" onClick="osp_dateselection_init(\'' + yearselect_id + '\', \'' + monthselect_id + '\',\'' + dayselect_id + '\');popupCalendar(\''+inputfield_id+'\');" alt="" style="cursor: pointer;" title="Popup date selector" />');
