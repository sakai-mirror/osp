/**********************************************************************************
 * $URL: https://source.sakaiproject.org/svn/tags/sakai_2-1-2/legacy/component/src/java/org/sakaiproject/component/legacy/content/BaseContentService.java $
 * $Id: BaseContentService.java 7328 2006-04-03 12:11:27 -0400 (Mon, 03 Apr 2006) lance@indiana.edu $
 ***********************************************************************************
 *
...
//       EventTrackingService.post(EventTrackingService.newEvent(EVENT_RESOURCE_READ, collection.getReference(), false));
   ...
   public List findResources(String type, String primaryMimeType, String subMimeType) {
      ...
      // The below code seems unnecessary since the user's own site resources should 
      //  be included in the above code - chmaurer 
      /*
