...
alter table osp_scaffolding_cell_attachments drop foreign key FK904DCA92754F20BD;
...
create table osp_scaffolding_cell_attachments  (wiz_page_def_id varchar(36) not null, artifact_id  varchar(255), seq_num integer not null, primary key (wiz_page_def_id, seq_num));
...
alter table osp_scaffolding_cell_attachments add index FK904DCA92754F20FF (wiz_page_def_id), add constraint FK904DCA92754F20FF foreign key (wiz_page_def_id) references osp_wizard_page_def (id);
